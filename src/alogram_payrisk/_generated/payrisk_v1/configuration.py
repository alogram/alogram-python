...
class Configuration:
    ...
    conf = alogram_payrisk._generated.payrisk_v1.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor"""
        self._base_path = "https://api-dev.alogram.ai/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("alogram_payrisk._generated.payrisk_v1")
    ...
    def to_debug_report(self) -> str:
        ...
        return (
            ...
            "Version of the API: 0.1.6-rc.3\n"
            "SDK Package Version: 0.1.6-rc.3".format(
        ...
        return [
            {
                ...
                "variables": {
                    "environment": {
                        ...
                        "default_value": "dev",
                        "enum_values": ["dev", "nonprod", "sandbox"],
                    },
                    "version": {
                        "description": "No description provided",
                        "default_value": "v1",
