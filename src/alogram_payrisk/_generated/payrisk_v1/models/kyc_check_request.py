...
class KycCheckRequest(BaseModel):
    ...
    def event_subtype_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['pre_kyc_check', 'doc_scan', 'liveness', 'address_check', 'sanctions_pep']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in KycCheckRequest) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "kyc": KycPayload.from_dict(obj["kyc"]) if obj.get("kyc") is not None else None
        })
        return _obj
