...
import payrisk_v1.models
from dateutil.parser import parse
from payrisk_v1 import rest
from payrisk_v1.api_response import ApiResponse
from payrisk_v1.api_response import T as ApiResponseT
from payrisk_v1.configuration import Configuration
from payrisk_v1.exceptions import (ApiException, ApiValueError,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(payrisk_v1.models, klass)
