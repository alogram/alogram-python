# Alogram PayRisk SDK for Python — AI Integration Guide
...
**Method**: `AlogramRiskClient.check_risk(request: CheckRequest)`
**Critical Parameters**: 
...
**Method**: `AlogramPublicClient.ingest_signals(request: SignalsRequest)`
...
## 🧪 Testing
- **Local Mocking**: Use `alogram_payrisk.testing.MockRiskClient` for unit tests.
